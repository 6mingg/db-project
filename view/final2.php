            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link" href="../view/cartnew2.php" style="width:60px;">購物車</a></li>
        ...
        <aside class="py-5 bg-light">
            <div class="container">
                <div class="w">
                    ...
                    <div class="col-md-4"><a class="btn btn-lg btn-secondary btn-block" href="../view/cartnew2.php" style="width:1120px;">購物車</a></div>
                </div>
            </div>
        </aside>
